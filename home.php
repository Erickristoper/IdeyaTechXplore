  ...
  <p class="title">Shopper</p>
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link" data-toggle="tab" href="#2a">ORDERS</a>
            </li>
                       ...
                       <?php  
                         ...
                         $array = json_decode($strJsonFileContents, true);
                          ...
                          foreach($array['cart'] as $cart) {
                           ...
                           echo "<div class = 'row'>";
                           echo "<div id='list'>";
                           echo "<h5>" . 'Shopping List 1' . "</h5>";                         
                           echo "<h5>" . 'SM North Hypermarket'. "</h5>";
                           echo "<h5>" . '4 Items on list'. "</h5>";
                           echo "<h5>" . 'Last Transaction: July 20, 2019'. "</h5>";
                           echo "</div>";
                           echo "<div>";
